...
STAFF_ROLE_DICT = {
    ...
    'QUALITY CONTROL ARCHIVE': groups.QUALITY_CONTROL_ARCHIVE_CLERK,
    'QUALITY CONTROL ARCHIVE CLERK': groups.QUALITY_CONTROL_ARCHIVE_CLERK,
    'QUALITY CONTROL ARCHIVE SUPERVISOR': groups.QUALITY_CONTROL_ARCHIVE_SUPERVISOR,
